...
export default function AdminDashboard({ users, onUserSelect }) {
  ...
  const metricCards = stats ? [
    { icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>, label: "Toplam Kullanıcı", value: stats.totalUsers, color: tokens.primary },
    { icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>, label: "Aktif Kullanıcı", value: stats.activeUsers, color: tokens.success },
    { icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg>, label: "Yeni Kullanıcı (7 gün)", value: stats.newUsers, color: "#3B82F6" },
    { icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>, label: "Admin Sayısı", value: stats.adminCount, color: "#8B5CF6" },
    { icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"/></svg>, label: "Engellenen Kullanıcı", value: stats.blockedUsers, color: tokens.danger },
    { icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>, label: "Toplam Başvuru", value: stats.totalApplications, color: "#F59E0B" },
  ] : [];
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        >
          ...
          >
            <span style={{ fontSize: 14, fontWeight: 700, color: tokens.textPrimary }}>Son Kayıtlı Kullanıcılar</span>
            <button
          ...
          <div style={{ maxHeight: 340, overflowY: "auto" }}>
            {recentUsers.length === 0 ? (
              <div className="text-center py-10" style={{ color: tokens.muted, fontSize: 13 }}>Henüz kullanıcı yok</div>
            ) : (
              recentUsers.map(u => (
                <button
                  key={u.id}
                ...
                >
                  ...
                  <div className="flex-shrink-0 text-right">
                    ...
                    >
                      {u.is_allowed === false ? "Engelli" : "Aktif"}
                    </div>
                  </div>
                </button>
              ))
        ...
        >
          ...
          <div className="p-5">
            <div className="flex flex-col gap-4">
              {stats && [
                { label: "Aktif Kullanıcılar", value: stats.activeUsers, total: stats.totalUsers, color: tokens.success },
                { label: "Engellenen Kullanıcılar", value: stats.blockedUsers, total: stats.totalUsers, color: tokens.danger },
                { label: "Son 7 Gün Kayıt", value: stats.newUsers, total: stats.totalUsers, color: "#3B82F6" },
              ].map((item, i) => (
                <div key={i}>
